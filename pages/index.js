        ...
        <Scrollbars
          ...
          >
            ...
            <div style={{boxShadow: "0px 1px 3px 2px #00000029",display:"flex",backgroundColor:templatePropertiesData.tempBackgroundColorPicker}}>
                <div id='pdf' style={{height:`${templatePropertiesData.pageSize === "A5" ? "250mm" : "297mm"}`,width:`${templatePropertiesData.pageSize === "A5" ? "2200mm" : "270mm"}`,border:"1px solid #9E9E9E",marginTop:templatePropertiesData.marginTop !== undefined ? `${templatePropertiesData.marginTop}px` : "67px",marginLeft:templatePropertiesData.marginLeft !== undefined ?  `${templatePropertiesData.marginLeft}px`  : "67px",marginBottom:templatePropertiesData.marginBottom !== undefined ? `${templatePropertiesData.marginBottom}px`: "38px",marginRight:templatePropertiesData.marginRight !== undefined ? `${templatePropertiesData.marginRight}px`: "38px"}}>
