...
const print =()=>{
  ...
  return (
    ...
    >
      ...
      >
        <Menu.Item style={{padding:"4px 0 9px 0",height:"66px",width:"100%",marginLeft:"0px",backgroundColor: `${isKey === "0" ? "#2f2f38" : "#3c3c47"}`,color: `${isKey === "0" ? "#1abc9c" : "white"}`}} key={"0"}>
        ...
        <Menu.Item style={{padding:"9px 0 0 0",height:"48px",width:"100%",marginLeft:"0px",backgroundColor: `${isKey === "1" ? "#2f2f38" : "#3c3c47"}`,color:`${isKey === "1" ? "#1abc9c" : "white"}`,fontSize:"10px"}} key={"1"}>
          <div style={{display:"flex",flexDirection:'column',textAlign:"center"}}>
          <CreditCardOutlined />
          <span style={{marginLeft:"0px",marginTop:"-12px"}}>Header</span>
          </div>
        </Menu.Item>
        <Menu.Item style={{padding:"9px 0 0 0",height:"48px",width:"100%",marginLeft:"0px",backgroundColor: `${isKey === "2" ? "#2f2f38" : "#3c3c47"}`,color:`${isKey === "2" ? "#1abc9c" : "white"}`,fontSize:"10px"}} key={"2"}>
          <div style={{display:"flex",flexDirection:'column',textAlign:"center"}}>
          <FileOutlined />
          <span style={{marginLeft:"-2px",marginTop:"-10px"}}>Item Table</span>
          </div>
        </Menu.Item>
        <Menu.Item style={{padding:"9px 0 0 0",height:"48px",width:"100%",marginLeft:"0px",backgroundColor: `${isKey === "3" ? "#2f2f38" : "#3c3c47"}`,color:`${isKey === "3" ? "#1abc9c" : "white"}`,fontSize:"10px"}} key={"3"}>
          <div style={{display:"flex",flexDirection:'column',textAlign:"center"}}>
          <TableOutlined />
          <span style={{marginLeft:"-5px",marginTop:"-10px"}}>Total</span>
          </div>
        </Menu.Item>
        <Menu.Item style={{padding:"9px 0 0 0",height:"48px",width:"100%",marginLeft:"0px",backgroundColor: `${isKey === "4" ? "#2f2f38" : "#3c3c47"}`,color:`${isKey === "4" ? "#1abc9c" : "white"}`,fontSize:"10px"}} key={"4"}>
          <div style={{display:"flex",flexDirection:'column',textAlign:"center"}}>
          <MailOutlined />
          <span style={{marginLeft:"-5px",marginTop:"-10px"}}>Footer</span>
          </div>
        </Menu.Item>
        <Menu.Item style={{padding:"9px 0 0 0",height:"48px",width:"100%",marginLeft:"0px",backgroundColor: `${isKey === "5" ? "#2f2f38" : "#3c3c47"}`,color:`${isKey === "5" ? "#1abc9c" : "white"}`,fontSize:"10px"}} key={"5"}>
          <div style={{display:"flex",flexDirection:'column',textAlign:"center"}}>
        ...
        <Scrollbars
          ...
          >
            ...
            <div style={{boxShadow: "0px 1px 3px 2px #00000029",display:"flex",backgroundColor:templatePropertiesData.tempBackgroundColorPicker}}>
                <div id='pdf' style={{height:`${templatePropertiesData.pageSize === "A5" ? "250mm" : "350mm"}`,width:`${templatePropertiesData.pageSize === "A5" ? "250mm" : "350mm"}`,border:"1px solid #9E9E9E",marginTop:templatePropertiesData.marginTop !== undefined ? `${templatePropertiesData.marginTop}px` : "167px",marginLeft:templatePropertiesData.marginLeft !== undefined ?  `${templatePropertiesData.marginLeft}px`  : "67px",marginBottom:templatePropertiesData.marginBottom !== undefined ? `${templatePropertiesData.marginBottom}px`: "38px",marginRight:templatePropertiesData.marginRight !== undefined ? `${templatePropertiesData.marginRight}px`: "38px"}}>
