...
import { Button,Row,Col, Form ,Input,InputNumber,Select,Checkbox,Popover} from 'antd';
...
const ItemTable = ()=>{
    ...
    return(
        ...
        <div style={{height:"64px",borderBottom:"1px solid #E4E4E4",display:"flex",alignItems:"center"}}>
                <h1 style={{fontSize:"16px",fontWeight:"500",marginLeft:"12px"}}>Item Table</h1>
            </div>
            <div style={{marginLeft:"12px",marginTop:"20px",marginBottom:"25px"}}>
              <Button onClick={()=>setLayoutType("labels")} style={{height:"42px",borderRadius:"5px",width:"102px",backgroundColor:`${layoutType === "labels" ? "#1ABC9C" : "#E4E4E4"}`,marginRight:"15px"}}>Labels</Button>
              <Button onClick={()=>setLayoutType("layout")} style={{height:"42px",borderRadius:"5px",width:"102px",backgroundColor:`${layoutType === "layout" ? "#1ABC9C" : "#E4E4E4"}`}}>Layout</Button>
            </div>
           {
            layoutType === "labels" ? 
            <>
            ...
            <Form.Item name="tableLineItemNumberWidth" initialValue={35} >
                <InputNumber defaultValue={35} style={{borderRadius:"5px"}} />
              </Form.Item>
              <Form.Item initialValue={195} name="tableItemWidth">
                    <InputNumber defaultValue={195} style={{borderRadius:"5px"}}/>
              </Form.Item>
              <Form.Item initialValue={75} name="tableDescriptionWidth">
                    <InputNumber defaultValue={75} style={{borderRadius:"5px"}}/>
              </Form.Item>
              ...
              <Form.Item initialValue={92} name="tableAmountWidth">
                    <InputNumber defaultValue={92} style={{borderRadius:"5px"}}/>
              </Form.Item>
            </Col>
            <Col span={9} style={{marginTop:"12px"}}>
            <Form.Item initialValue={"#"} name="tableLineItemNumberLabel" >
              <Input style={{width:"140px",borderRadius:"5px"}}/>
              </Form.Item>
