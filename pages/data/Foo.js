...
const Footer = ()=>{
    ...
    return(
        ...
        <div style={{height:"64px",borderBottom:"1px solid #E4E4E4",display:"flex",alignItems:"center"}}>
                <h1 style={{fontSize:"16px",fontWeight:"500",marginLeft:"12px"}}>Footer</h1>
            </div>
            ...
            <Col span={10} >
              ...
              <Input style={{width:"210px",borderRadius:"5px"}} placeHolder="Notes"></Input>
              </Form.Item>
                </Col>
                <Col span={10} >
            ...
            <Form.Item name="footerOnlinePaymentLinkCheck" initialValue={false} valuePropName="checked" style={{marginRight:"20px",display:"flex"}} >
              ...
              <Input style={{width:"178px",marginLeft:"13px",borderRadius:"5px"}} ></Input>
              </Form.Item>
                </Col>
