...
const TemplateProperties = ()=>{
    ...
    const [tempLabelColor,setTempLabelColor] = useState("#ffffff");
    ...
    return(
        ...
        <Form form={form}  layout="vertical" name="form" onValuesChange={onChangeData}>
            <div style={{marginLeft:"8px",borderRight:"9px solid #E4E4E4 ",position:"relative'"}}>
            <div style={{height:"64px",borderBottom:"1px solid #E4E4E4",display:"flex",alignItems:"center"}}>
            <h1 style={{fontSize:"16px",fontWeight:"500",marginLeft:"12px"}}>TemplateProperties</h1></div>
            <div style={{marginLeft:"12px"}}>
            <Form.Item name="templateName" label="Template Name" style={{marginTop:"25px",width:"365px"}}>
              <Input placeHolder={"Spreadsheet Template"} style={{borderRadius:"5px"}}></Input>
            </Form.Item>
            ...
            <div style={{marginTop:"8px",display:"flex"}}>
              ...
              <Form.Item name="marginTop" initialValue={67}>
                  <InputNumber defaultValue={67} style={{width:"73px",marginRight:"23px",borderRadius:"5px"}}/>
              </Form.Item>
              ...
              <Form.Item name="marginRight"   initialValue={52}>
                            <InputNumber defaultValue={52} style={{width:"73px",borderRadius:"5px"}}/>
                        </Form.Item>
            ...
            <Select style={{width:"365px"}} ></Select>
             ...
             <Col span={12}>
              <Form.Item name="tempFontSize"  initialValue={12}>
                ...
                <InputNumber defaultValue={12} style={{width:"170px",marginLeft:"10px",borderRadius:"5px"}} ></InputNumber>
              </Form.Item>
             </Col>
