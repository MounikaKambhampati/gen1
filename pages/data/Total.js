...
const Total = ()=>{
  ...
  return(
      ...
      <div style={{height:"64px",borderBottom:"1px solid #E4E4E4",display:"flex",alignItems:"center"}}>
                <h1 style={{fontSize:"16px",fontWeight:"500",marginLeft:"12px"}}>Total</h1>
            </div>
             <div style={{marginLeft:"12px",marginTop:"20px",marginBottom:"25px"}}>
               <Button onClick={()=>setItemLayoutType("labels")} style={{height:"42px",borderRadius:"5px",width:"102px",backgroundColor:`${itemLayoutType === "labels" ? "#1ABC9C" : "#E4E4E4"}`,marginRight:"15px"}}>Labels</Button>
               <Button onClick={()=>setItemLayoutType("layout")} style={{height:"42px",borderRadius:"5px",width:"102px",backgroundColor:`${itemLayoutType === "layout" ? "#1ABC9C" : "#E4E4E4"}`}}>Layout</Button>
             </div>
            {
             ...
             <Col span={10} >
              ...
              <Checkbox>Sub Total</Checkbox>
               ...
               <Input style={{width:"180px",borderRadius:"5px"}}></Input>
               </Form.Item>
                 </Col>
                 <Col span={10} >
               ...
               <Input style={{width:"210px",borderRadius:"5px"}}></Input>
               </Form.Item>
                 </Col>
                 <Col span={10} >
              ...
              <p style={{marginTop:"5px"}}>Payment Made</p>
                 ...
                 <Col span={14}>
                  <Form.Item name="totalPaymentMade" initialValue="">
                    <Input style={{width:"210px",borderRadius:"5px"}} placeHolder={"Payment Made"}></Input>
                  </Form.Item>
                 </Col>
                 <Col span={10} >
              <p style={{marginTop:"5px"}}>Credits Applied</p>
                 ...
                 <Col span={14}>
                  <Form.Item  name="totalCreditsApplied"  initialValue="">
                    <Input style={{width:"210px",borderRadius:"5px"}} placeHolder="Credits Applied"></Input>
                  </Form.Item>
                 </Col>
                 <Col span={10} >
              <p style={{marginTop:"5px"}}>Amount Withheld</p>
                 ...
                 <Col span={14}>
                  <Form.Item  name="totalAmountWithheld" initialValue="">
                    <Input style={{width:"210px",borderRadius:"5px"}} placeHolder="Amount Withheld"></Input>
                  </Form.Item>
                 </Col>
                 <Col span={10} >
              <p style={{marginTop:"5px"}}>Write Off Amount</p>
                 ...
                 <Col span={14}>
                  <Form.Item  name="totalWriteOffAmount" initialValue="">
                    <Input style={{width:"210px",borderRadius:"5px"}} placeHolder="Write Off Amount"></Input>
                  </Form.Item>
                 </Col>
                 <Col span={10} >
              <p style={{marginTop:"5px"}}>Balance Due</p>
                 ...
                 <Col span={14}>
                  <Form.Item  name="totalBalanceDue" initialValue="">
                    <Input style={{width:"210px",borderRadius:"5px"}} placeHolder="Balance Due"></Input>
                  </Form.Item>
                 </Col>
                 <Col span={10} >
             ...
             <Col span={10} >
               ...
               <InputNumber defaultValue={11} style={{width:"210px",borderRadius:"5px"}}></InputNumber>
               </Form.Item >
                 </Col>
                 <Col span={10} >
          ...
          <Form.Item name="totalFontColorCheck"  initialValue={false} valuePropName="checked" style={{marginRight:"20px",display:"flex"}} >
           ...
           <Form.Item name="setTotalFontColor" initialValue={totalFontColor} style={{marginRight:"20px",display:"flex",marginLeft:"10px"}}>
            <Input style={{width:"155px",borderRadius:"5px"}}/>
            </Form.Item> 
           </Col>
          ...
          <Form.Item name="totalBackgroundColorCheck"  initialValue={false} valuePropName="checked" style={{marginRight:"20px",display:"flex"}} >
           ...
           <Col span={1} style={{marginTop:"-4px"}}>
            ...
            <p style={{height:"30px",width:"32px",backgroundColor:totalBackgroundColor=== undefined ? "#ffffff": totalBackgroundColor,border:"1px solid #9E9E9E"}} ></p>
             ...
             <Col span={10} >
               ...
               <InputNumber defaultValue={12} style={{width:"210px",borderRadius:"5px"}}></InputNumber>
               </Form.Item>
                 </Col>
                 <Col span={10} >
                 <p style={{height:"32px",textAlign:"start",marginTop:"0"}}>Font Color</p>
           ...
           <Form.Item name="totalBalanceDueFontColor" initialValue={totalBalanceDueFontColor} style={{marginRight:"20px",display:"flex"}}>
            <Input style={{width:"185px",borderRadius:"5px"}}/>
            </Form.Item> 
           </Col>
           <Col span={1} style={{marginTop:"-4px"}}>
