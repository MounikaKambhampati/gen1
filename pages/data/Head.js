...
const Header = ()=>{
  ...
  return(
      ...
      <div style={{height:"64px",borderBottom:"1px solid #E4E4E4",display:"flex",alignItems:"center"}}>
                <h1 style={{fontSize:"16px",fontWeight:"500",marginLeft:"12px"}}>Header</h1>
            </div>
          <div >
          ...
          {logoChecked ? <Form.Item name="orgLogoImage" style={{ color: "#8E8E8E", fontSize: "13px", marginTop: "-17px",marginLeft:"20px",marginBottom:"30px" }}>
                    <Upload
                      ...
                      maxCount={1}
                    >
                      <Button style={{borderRadius:"5px"}} icon={<UploadOutlined />}>Upload data</Button>
                    </Upload>
          </Form.Item>: null}
          {imageSize ? 
          ...
          <Form.Item name="orgTitleString" style={{marginTop:"-23px",width:"365px",borderRadius:"5px"}}>
          <Input/>
          </Form.Item>
          <div style={{marginBottom:"25px"}}>
            Background Image
            <div style={{marginTop:"25px"}}>
            <span style={{width:"156px",height:"31px",backgroundColor:"#F5F5F5",border:"1px solid #DDDDDD",padding:"5px 10px",height:"31px",borderRadius:"5px",marginRight:"5px",fontSize:"13px"}}> Choose From Desktop</span>
            <span style={{width:"156px",height:"31px",backgroundColor:"#F5F5F5",border:"1px solid #DDDDDD",padding:"5px 10px",height:"31px",borderRadius:"5px",fontSize:"13px"}}> Choose From Gallery</span>
            </div>
          </div>
          ...
          <Form.Item name="headerBackgroundColorCheck" style={{marginRight:"20px",display:"flex"}}  initialValue={false} valuePropName="checked">
           ...
           <Form.Item name="headerBackgroundColor" label="Background Color" initialValue={headerBackgroundColor} style={{display:"flex",marginLeft:"10px"}}>
            <Input style={{width:"124px",borderRadius:"5px"}} />
            </Form.Item> 
           </Col>
          ...
          <div style={{marginLeft:"12px",fontSize:"16px",fontWeight:"600",marginBottom:"15px"}}>
            ...
            <InputNumber defaultValue={30} style={{width:"190px",borderRadius:"5px"}}></InputNumber>
            </Form.Item>
              </Col>
              <Col span={12} >
            ...
            <Input style={{width:"190px",borderRadius:"5px"}} ></Input>
            </Form.Item>
              </Col>
            </Row>
          <div style={{marginLeft:"12px",fontSize:"16px",fontWeight:"600",marginBottom:"15px"}}>
          Organization
           ...
           <Form.Item name="headerNameColor" label="Name Color" initialValue={headerNameColor} style={{marginRight:"20px",display:"flex",marginLeft:"10px"}}>
            <Input style={{width:"145px",borderRadius:"5px"}} />
            </Form.Item> 
           </Col>
           <Col span={1} style={{marginTop:"25px"}}>
            <div style={{marginLeft:'-36px',paddingTop:"5px",borderRadius:"5px"}}> 
            <Popover 
            content={
              <div >
           ...
           <HexColorPicker  />
            ...
            <InputNumber defaultValue={16} style={{width:"170px",borderRadius:"5px"}} ></InputNumber>
            </Form.Item>
              </Col>
              <Col span={12} style={{marginLeft:"12px"}}>
              <Form.Item name="headerPhone" label="Phone" style={{marginRight:"20px"}} >
            <Input style={{width:"170px",borderRadius:"5px"}}></Input>
            </Form.Item>
              </Col>
              <Col span={12} style={{marginLeft:"-12px"}}>
          ...
          <Row style={{marginLeft:"12px"}}>
            ...
            <InputNumber defaultValue={12} style={{width:"170px",borderRadius:"5px"}} ></InputNumber>
            </Form.Item>
              </Col>
            </Row>
            <div style={{marginLeft:"12px"}}>
              ...
              <Form.Item style={{marginBottom:"15px"}} name="headerBillTo" initialValue="Bill To">
                <Input defaultValue="Bill To" style={{width:"320px",borderRadius:"5px"}} ></Input>
              </Form.Item>
            </div>
            <div style={{marginLeft:"12px"}}>
              ...
              <Form.Item style={{marginBottom:"15px"}} name="headerShipTo">
                <Input defaultValue="Ship To" style={{width:"320px",borderRadius:"5px"}} ></Input>
              </Form.Item>
            </div>
            <div style={{marginLeft:"12px",fontSize:"16px",fontWeight:"600",marginBottom:"15px"}}>
          ...
          <Row style={{marginLeft:"12px"}}>
            ...
            <Input defaultValue="#" style={{width:"190px",borderRadius:"5px"}} ></Input>
            </Form.Item >
              </Col>
              <Col span={12} >
            ...
            <Input defaultValue="Date Field" style={{width:"190px",borderRadius:"5px"}} ></Input>
            </Form.Item >
              </Col>
              <Col span={12} >
            ...
            <Input defaultValue="Terms" style={{width:"190px",borderRadius:"5px"}} ></Input>
            </Form.Item >
              </Col>
              <Col span={12} >
            ...
            <Input defaultValue="Due Date" style={{width:"190px",borderRadius:"5px"}} ></Input>
            </Form.Item >
              </Col>
              <Col span={12} >
